...
************************************************************************/
SMBIOS_TABLE_TYPE4 mProcessorInfoType4_x2 = {
...
CHAR8 mCpuName[128] = "Qualcomm Snapdragon 8 Gen 1 plus";

CHAR8 *mProcessorInfoType4Strings[] = {
    "BGA", "Qualcomm", "Snapdragon 8 Gen 1 plus", NULL};
...
VOID RegisterSOCSmbiosInfo(
  ...
  mProcessorInfoType4_x2.L2CacheHandle = (UINT16)SmbiosHandle;
  ...
  LogSmbiosData(
      (EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_x2,
