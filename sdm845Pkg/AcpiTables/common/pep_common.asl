...
//		 {
//			 GpioInt(Edge, ActiveBoth, Shared, PullUp, 0, "\\_SB.PM01",,,,RawDataBuffer(){0x20, 0x2, 0x1, 0x8}) {0x1003}
//			 GpioInt(Edge, ActiveBoth, Shared, PullUp, 0, "\\_SB.PM01",,,,RawDataBuffer(){0x21, 0x2, 0x1, 0x8}) {0x1004}
//		 })
//		Return (RBUF)
//	 }
